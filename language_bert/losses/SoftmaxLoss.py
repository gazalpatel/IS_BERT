...
class SoftmaxLoss(nn.Module):
    """
    This loss was used in our SBERT publication (https://arxiv.org/abs/1908.10084) to train the LanguageTransformer
    ...
    Example::
        ...
        from sentence_transformers import LanguageTransformer, SentencesDataset, losses
