...
from language_bert import util
from language_bert.LanguageTransformer import LanguageTransformer
...
class BatchHardTripletLoss(nn.Module):
    ...
    :param model: LanguageTransformer model
    :param distance_metric: Function that returns a distance between two emeddings. The class SiameseDistanceMetric contains pre-defined metrices that can be used


    Example::

       from language_bert import LanguageTransformer, SentencesDataset, losses
       from language_bert.readers import InputExample

       model = LanguageTransformer('distilbert-base-nli-mean-tokens')
    ...
    """
    def __init__(self, model: LanguageTransformer, distance_metric = BatchHardTripletLossDistanceFunction.eucledian_distance, margin: float = 5):
