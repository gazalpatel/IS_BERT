...
class BatchHardSoftMarginTripletLoss(BatchHardTripletLoss):
    ...
    Example::
       ...
       from language_bert import LanguageTransformer,  SentencesDataset, LoggingHandler, losses
    ...
    """
    def __init__(self, model: LanguageTransformer, distance_metric=BatchHardTripletLossDistanceFunction.eucledian_distance):
