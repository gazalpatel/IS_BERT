...
class TripletLoss(nn.Module):
    ...
    :param model: LanguageTransformerModel
    ...
    Example::
        ...
        from sentence_transformers import LanguageTransformer,  SentencesDataset, LoggingHandler, losses
    ...
    """
    def __init__(self, model: LanguageTransformer, distance_metric=TripletDistanceMetric.EUCLIDEAN, triplet_margin: float = 5):
