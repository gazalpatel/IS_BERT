...
from .. import LanguageTransformer
...
class SentenceLabelDataset(Dataset):
    ...
    def __init__(self, examples: List[InputExample], model: LanguageTransformer, provide_positive: bool = True,
        ...
        LanguageTransformer.smart_batching_collate as the collate_fn for the DataLoader
    ...
    def convert_input_examples(self, examples: List[InputExample], model: LanguageTransformer):
        """
